  ...
  const frames: StoryboardFrame[] = [
    ...
    },
    {
      ...
      content: {
        ...
        visualDescription: 'Two inserts: (1) production-brief JSON with formatVersion 2 and a green schema-valid chip; (2) a quote card "6 shots · 0 blocked". Dark void background, same as the board.',
        ...
        testCriteria: [
          ...
          'JSON still is readable as formatVersion 2 at 1080p',
